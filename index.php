  ...
  <div class="container-fluid mt-3">
    <div class="row justify-content-center">
      ...
      if(isset($_SESSION['reg'])){
        ...
        <p>
          <a href="index.php?page=uploadproject">My Account</a> | <a class="red-text" href="logout.php">Logout</a>
        </p>
        ...
        <p>
          <a href="index.php?page=login">Login</a> | <a href="index.php?page=register">Register</a> | <a href="/searchengine/admin">Admin</a> 
        </p>
        <?php
      }
      ?>
